...
#include "MasterMainClass_mock.hpp"

struct MasterMainClass_test : testing::Test {
    mock::MasterMainClass_mock model;
    
    MasterMainClass_test() : model{}{
        ;
    }
    
    ~MasterMainClass_test() = default;
};

TEST_F(MasterMainClass_test, MasterMainClass_test_foo_test){
...
TEST_F(MasterMainClass_test, MasterMainClass_test_fooint_test){
...
TEST_F(MasterMainClass_test, MasterMainClass_test_foo2_test){
...
TEST_F(MasterMainClass_test, MasterMainClass_test_foo2_test2){
...
TEST_F(MasterMainClass_test, MasterMainClass_test_foo2_test3){
    EXPECT_CALL(model, foo2(testing::Matcher<int>(testing::_)))
            .WillOnce(testing::Return(0));
...
TEST_F(MasterMainClass_test, MasterMainClass_test_foo3_test0){
