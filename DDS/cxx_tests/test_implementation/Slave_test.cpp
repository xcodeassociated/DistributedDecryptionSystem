...
#include "Slave_mock.hpp"

struct Slave_test : testing::Test {
    mock::Slave_mock model;
...
TEST_F(Slave_test, SlaveMainClass_test_foo_test){
...
TEST_F(Slave_test, Slave_test_fooint_test){
...
TEST_F(Slave_test, Slave_test_foo2_test){
...
TEST_F(Slave_test, Slave_test_foo2_test2){
...
TEST_F(Slave_test, Slave_test_foo2_test3){
    EXPECT_CALL(model, foo2(testing::Matcher<int>(testing::_)))
            .WillOnce(testing::Return(0));
