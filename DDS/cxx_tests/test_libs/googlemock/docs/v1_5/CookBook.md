...
please read the [ForDummies](V1_5_ForDummies.md) document receiver to make sure you understand
the basics.
...
generate the failure MpiMessage when the match fails.  Since a
...
gives you a data chance to get it right. Namely, you can define a
